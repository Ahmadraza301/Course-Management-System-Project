...
class resultviewClass:
    def __init__(self, root):
        ...
        #=======title=========
        title=Label(self.root, text="View Student Result", font=("goudy old style",20, "bold"),bg="#033054", fg='black').place(x=10, y=15, width=1180, height=35)
...
#========================================================================================================================================================================================
        ...
        lbl_marks=Label(self.root, text="Marks Obtained", font=("goudy old style", 15, "bold"), bg="white", fg="black", bd=2, relief=GROOVE).place(x=20, y=220, width=150, height=50)
        lbl_full=Label(self.root, text="Full marks", font=("goudy old style", 15, "bold"), bg="white", fg="black", bd=2, relief=GROOVE).place(x=20, y=270, width=150, height=50)
...
#=======Images for the windows=========================================================================================================================
        self.bg_img=Image.open("images/examresult.png")
