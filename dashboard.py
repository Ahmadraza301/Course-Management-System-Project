...
class CMS:
    def __init__(self, root):
        ...
        btn_course=Button(M_Frame, text="Add Courses", font=("goudy old style", 15, "bold"), bg="#0b5377", fg="white", cursor="hand2", command=self.add_course).place(x=20, y=5, width=200, height=40)
        ...
        btn_result=Button(M_Frame, text=" Add Results", font=("goudy old style", 15, "bold"), bg="#0b5377", fg="white", cursor="hand2", command=self.add_result).place(x=20, y=145, width=200, height=40)
        ...
        btn_summary=Button(M_Frame, text="Result Summary", font=("goudy old style", 15, "bold"), bg="#0b5377", fg="white", cursor="hand2", command=self.view_summary).place(x=20, y=285, width=200, height=40)
