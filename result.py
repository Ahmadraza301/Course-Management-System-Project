...
class Resultclass:
    def __init__(self, root):
        ...
        #=======title=========
        title=Label(self.root, text=" Add Result of Student", font=("goudy old style",20, "bold"),bg="#033054", fg='white').place(x=10, y=15, width=1180, height=35)
...
#=======Variables===================================================================================
        ...
        txt_marks=Entry(self.root, textvariable=self.var_marks, font=("goudy old style", 20, "bold"), bg='white').place(x=280, y=280, width=320)
        txt_full_marks=Entry(self.root, textvariable=self.var_full_marks, font=("goudy old style", 20, "bold"), bg='white').place(x=280, y=340, width=320)
#========Buttons======================================================================================================================================================================
        btn_add=Button(self.root, text="Submit", font=("goudy old style", 15), bg="green", activebackground="green", cursor="hand2", command=self.add).place(x=280, y=420, width=120, height=35)
        btn_clear=Button(self.root, text="Clear", font=("goudy old style", 15), bg="grey", activebackground="lightgreen", cursor="hand2", command=self.clear).place(x=480, y=420, width=120, height=35)

        
#=========Images for the windows==========================================================================        

        self.bg_img=Image.open("images/resultsss.jpg")
